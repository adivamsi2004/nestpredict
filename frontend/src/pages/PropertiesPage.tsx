...
import { assessProperty } from "@/lib/functions";
...
const PropertiesPage = () => {
  ...
  const handleAssess = async (prop: any) => {
    ...
    try {
      const data = await assessProperty({
        image: prop.image,
  ...
  useEffect(() => {
    const fetchProperties = async () => {
      try {
        ...
        setProperties([...dbProperties, ...initialProperties]);
      } catch (error) {
        console.error("Failed to fetch properties from the server", error);
              ...
              <div className="relative aspect-[4/3] overflow-hidden">
                <img 
                  ...
                  onError={(e) => {
                    ...
                    target.src = "https://images.unsplash.com/photo-1560518883-ce09059eeffa?auto=format&fit=crop&q=80"; // Fallback real estate image
                  }}
                />
