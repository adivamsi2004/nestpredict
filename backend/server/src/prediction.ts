...
export async function runPredictImagePrice(
  ...
  const modelsToTry = ["gemini-2.0-flash-exp", "gemini-2.0-flash", "gemini-1.5-flash", "gemini-1.5-flash-latest"];
  ...
  ${payload.location ? `The property is located in ${payload.location}.` : ""}
